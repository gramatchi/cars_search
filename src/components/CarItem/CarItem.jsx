...
const CarItem = ({ car }) => {
  ...
  return (
    <div>
      <div className={`${styles.carContainer} ${isModalOpen ? styles.hidden : ''}`}>
        <div className={styles.carCard}>
          ...
          <div className={styles.carInfo}>
            ...
            <button className={styles.learnMoreBtn} onClick={handleLearnMoreClick}>Learn more</button>
          </div>
        </div>
      </div>
      {isModalOpen && <CarModal car={car} extractedWords={extractedWords} onClose={handleCloseModal} />}
    </div>
  );
};
